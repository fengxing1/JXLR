 ...
 *  背景色
 */ 
#define CoreLockViewBgColor rgba(0,0,0,1)
 ...
 *  外环线条颜色：选中
 */
#define CoreLockCircleLineSelectedColor rgba(253,83,83,1)


/*
 *  实心圆
 */
#define CoreLockCircleLineSelectedCircleColor rgba(253,83,83,1)


/*
 *  连线
 */
#define CoreLockLockLineColor rgba(253,83,83,1)
...
/** 验证密码：密码错误次数 */
extern int const CoreLockVerifyErrorTimes;
