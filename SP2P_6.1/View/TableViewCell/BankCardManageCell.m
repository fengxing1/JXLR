...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _backView = [[UIView alloc] initWithFrame:CGRectMake(230, 0, 70, 120)];
        _backView.backgroundColor = GreenColor;
        [self addSubview:_backView];
        
        _editBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        _editBtn.frame = CGRectMake(227, 0, 75, 120);
        ...
        UILabel *editLabel = [[UILabel alloc] initWithFrame:CGRectMake(248, 65, 30, 30)];
        editLabel.text = @"编辑";
