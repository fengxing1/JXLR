...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _questionLabel = [[UILabel alloc] initWithFrame:CGRectMake(28, 5, WidthScreen-50, 35)];
        ...
        _linelabel = [[UILabel alloc] initWithFrame:CGRectMake(15,36, WidthScreen-30,0.2)];
        ...
        _answerLabel = [[UILabel alloc] initWithFrame:CGRectMake(31,38, WidthScreen-50, 40)];
...
- (void)layoutSubviews
{
    ...
    if (self.object) {
        ...
        if ([self.object isMemberOfClass:[Questions class]])
        {
            ...
            _questionLabel.frame = CGRectMake(28, 5, WidthScreen-50, model.contentHeight);
            _linelabel.frame = CGRectMake(15,CGRectGetMaxY(_questionLabel.frame)+2, WidthScreen-30,0.2);
            _textlabel.frame = CGRectMake(14, CGRectGetMaxY(_questionLabel.frame)+5,25,15);
            _answerLabel.frame = CGRectMake(31,CGRectGetMaxY(_questionLabel.frame)+5, WidthScreen-50, model.answerSize);
