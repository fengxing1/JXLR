...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _imgLabel.backgroundColor = ColorBGGray;
        [self addSubview:_imgLabel];
        
        
        _depictLabel = [[UILabel alloc] initWithFrame:CGRectMake(90, 40, WidthScreen-110, 20)];
        ...
        _payLabel.backgroundColor = ColorBGGray;
