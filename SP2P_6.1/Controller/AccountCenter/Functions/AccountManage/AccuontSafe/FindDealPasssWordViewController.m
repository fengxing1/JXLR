...
- (void)initView
{
    ...
    UIImageView *imgView = [[UIImageView alloc] initWithFrame:CGRectMake(10, 21, 30, 30)];
    [imgView setImage:[UIImage imageNamed:@"find_dealpassword_success"]];
    //imgView.backgroundColor = [UIColor redColor];
    [self.view addSubview:imgView];
    
    _phoneLabel = [[UILabel alloc] initWithFrame:CGRectMake(50, 6, 255, 60)];
    ...
    //输入框
    _authCodeField = [[UITextField alloc] initWithFrame:CGRectMake(10, 76, 150,40)];
    ...
    _verifyBtn.frame = CGRectMake(185, 76, 120, 40);;
    ...
    nextBtn.frame = CGRectMake(10, 154, self.view.frame.size.width-20, 45);
