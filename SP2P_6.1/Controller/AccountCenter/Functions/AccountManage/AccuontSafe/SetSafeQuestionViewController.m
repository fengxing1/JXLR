...
- (void)initView
{
    ...
    for (int i = 0; i<3; i++) {
        ...
        UILabel *textlabel = [[UILabel alloc] initWithFrame:CGRectMake(16, 90*i+SpaceMediumSmall, 81, HeightSize)];
    ...
    //输入框
    _textfield1 = [[UITextField alloc] initWithFrame:CGRectMake(CGRectGetMaxX([self.view viewWithTag:(0+100)].frame) + 4, CGRectGetMidY([self.view viewWithTag:(0+100)].frame) - HeightSize/2, 200, HeightSize)];
    ...
    //输入框
    _textfield2 = [[UITextField alloc] initWithFrame:CGRectMake(CGRectGetMaxX([self.view viewWithTag:(1 + 100)].frame) + 4, CGRectGetMidY([self.view viewWithTag:(1+100)].frame) - HeightSize/2, 200, HeightSize)];
    ...
    //输入框
    _textfield3 = [[UITextField alloc] initWithFrame:CGRectMake(CGRectGetMaxX([self.view viewWithTag:(2 + 100)].frame) + 4, CGRectGetMidY([self.view viewWithTag:(2 + 100)].frame) - HeightSize/2, 200, HeightSize)];
    ...
    _questionComboBox1 = [[AJComboBox alloc] initWithFrame:CGRectMake(CGRectGetMaxX([self.view viewWithTag:(0 + 10)].frame) + 4, CGRectGetMidY([self.view viewWithTag:(0 + 10)].frame) - HeightSize/2, 200, HeightSize)];
    ...
    _questionComboBox2 = [[AJComboBox alloc] initWithFrame:CGRectMake(CGRectGetMaxX([self.view viewWithTag:(1 + 10)].frame) + 4, CGRectGetMidY([self.view viewWithTag:(1 + 10)].frame) - HeightSize/2, 200, HeightSize)];
    ...
    _questionComboBox3 = [[AJComboBox alloc] initWithFrame:CGRectMake(CGRectGetMaxX([self.view viewWithTag:(2 + 10)].frame) + 4, CGRectGetMidY([self.view viewWithTag:(2 + 10)].frame) - HeightSize/2, 200, HeightSize)];
