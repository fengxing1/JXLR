...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIView *line = [[UIView alloc]initWithFrame:CGRectMake(0, 0, WidthScreen, 1)];
    line.backgroundColor = ColorBGGray;
    ...
    reasonLabel.frame = CGRectMake(50, 10, WidthScreen-60, ViewSize.height+5);
    dropView.frame = CGRectMake(0, 0, WidthScreen, ViewSize.height+30);
...
- (void)moreBtnClick:(UIButton *)btn
{
    ...
    //NSLog(@"index1.setion is %ld",(long)index1.section);
    // NSIndexPath *index1 =  [NSIndexPath indexPathForItem:btn.tag inSection:0];
    UIFolderTableView *folderTableView = (UIFolderTableView *)_listView;
    
    UIView *dropView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, WidthScreen, 80)];
    dropView.backgroundColor = [UIColor whiteColor];
