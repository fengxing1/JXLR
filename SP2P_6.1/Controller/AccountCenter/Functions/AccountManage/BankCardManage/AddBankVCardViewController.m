...
- (void)initView
{
    ...
    UIView *viewLeftBank=[[UIView alloc] initWithFrame:CGRectMake(0, 0, 7.0f, 0)];
    ...
    _banknameField.leftView=viewLeftBank;
    ...
    UIView *viewLeftId=[[UIView alloc] initWithFrame:CGRectMake(0, 0, 7.0f, 0)];
    //账号输入框
    ...
    UIView *viewLeftName=[[UIView alloc] initWithFrame:CGRectMake(0, 0, 7.0f, 0)];
    //输入框
    ...
    _nameField.leftView=viewLeftName;
    _nameField.leftViewMode=UITextFieldViewModeAlways;
    [_scrollView addSubview:_nameField];
    
    UIButton *surebtn = [ToolButton CreateMainButton:CGRectMake(10, CGRectGetMaxY(_nameField.frame) + 16, self.view.frame.size.width-20, 45) withTitle:@"确 定" withTarget:self withAction:@selector(sureBtnClick)];
