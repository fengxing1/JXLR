...
{
    self.title = @"提现记录";
    UIView *backView = [[UIView alloc] initWithFrame:CGRectMake(0, SpaceSmall/2, self.view.frame.size.width, 40)];
    ...
    _listView = [[UIFolderTableView alloc] initWithFrame:CGRectMake(0, 45, self.view.frame.size.width, self.view.frame.size.height - 45) style:UITableViewStyleGrouped];
    _listView.delegate = self;
    _listView.dataSource = self;
    _listView.contentInset=UIEdgeInsetsMake(0, 0, SpaceBig, 0);
