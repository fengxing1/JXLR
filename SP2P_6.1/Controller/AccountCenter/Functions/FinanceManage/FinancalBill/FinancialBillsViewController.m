...
- (void)initView
{
    ...
    _listView = [[UITableView alloc] initWithFrame:CGRectMake(0, 40, self.view.frame.size.width, self.view.frame.size.height - 40-HeightNavigationAndStateBar) style:UITableViewStyleGrouped];
...
- (void)initNavigationBar
{
    ...
    // 导航条取消按钮(退出搜索键盘)
    BarButtonItem *cancelItem=[BarButtonItem barItemRightDefaultWithTitle:@"取消" target:self action:@selector(cancelClick)];
