...
- (void)initView
{
    ...
    _transferReason.frame = CGRectMake(85, 300, WidthScreen-120, 30);
...
-(void) httpResponseSuccess:(NetWorkClient *)client dataTask:(NSURLSessionDataTask *)task didSuccessWithObject:(id)obj
{
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        CGSize LabelSiZe = [_transferReason.text boundingRectWithSize:CGSizeMake(WidthScreen-120, 2000)options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil].size;
        _transferReason.frame =  CGRectMake(80, 300, WidthScreen-120, LabelSiZe.height);
