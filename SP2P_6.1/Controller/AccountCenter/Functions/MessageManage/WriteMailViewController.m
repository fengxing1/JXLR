...
- (void)initView
{
    ...
    for (int i=0; i<3; i++) {
        ...
        _nameField = [[UITextField alloc] initWithFrame:CGRectMake(85, 80, WidthScreen-130, 30)];
        ...
        _titleField = [[UITextField alloc] initWithFrame:CGRectMake(85, 125, WidthScreen-130, 30)];
        ...
        if (i == 2) {
            ...
            _contentView = [[UITextView alloc] initWithFrame:CGRectMake(25, 100+i*45, WidthScreen-50, 130) ];
