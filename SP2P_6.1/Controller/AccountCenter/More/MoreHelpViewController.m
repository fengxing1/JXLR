...
- (void)initContent
{
    _helpTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 280) style:UITableViewStyleGrouped];
    ...
    _helpTableView.contentInset=UIEdgeInsetsMake(0, 0, HeightNavigationAndStateBar, 0);
