...
- (void)initView
{
    ...
    UIView *topView = [[UIView alloc] initWithFrame:CGRectMake(10, 10, 300, 60)];
...
-(void) httpResponseSuccess:(NetWorkClient *)client dataTask:(NSURLSessionDataTask *)task didSuccessWithObject:(id)obj
{
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        if (titleArr.count % 2) {
            ...
            _downView.frame = CGRectMake(10, 80, 300, 205 + (titleArr.count * 0.5) * 35 + 50);
            
        }else {
            
            _downView.frame = CGRectMake(10, 80, 300, 195 + titleArr.count * 0.5 * 35 + 50);
