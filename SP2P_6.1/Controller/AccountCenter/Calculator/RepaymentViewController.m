...
- (void)initView
{
    ...
    // 上面白背景
    _topView = [[UIView alloc] initWithFrame:CGRectMake(10, 10, 300, 225)];
    ...
    // 中间白背景
    _middleView = [[UIView alloc] initWithFrame:CGRectMake(10, 245, 300, 210)];
    ...
    _downView.frame = CGRectMake(10, 465, 300, 135);
    ...
    for (int j = 0; j <= 1; j++) {
        ...
        if (j==0) {
            [heardlabel setFrame:CGRectMake(20, 260, 280, 30)];
            heardlabel.text = @"计算结果";
        }else {
            [heardlabel setFrame:CGRectMake(20, 475, 280, 30)];
...
- (void)setView {
    ...
    _downView.frame = CGRectMake(10, 465, 300, 85 + _listView.frame.size.height + 25);
    _scrollView.contentSize = CGSizeMake(self.view.frame.size.width, _downView.frame.origin.y + _downView.frame.size.height + 10);
