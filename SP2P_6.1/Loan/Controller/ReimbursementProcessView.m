...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.frame = CGRectMake(0, 0, WidthScreen, 150);
        ...
        for (int i = 0; i<2;i++) {
            ...
            if (i==0) {
                ...
                arrowlabel4.frame = CGRectMake(266.2, 36, 50, 12);
            ...
            else
            {
                ...
                arrowlabel4.frame = CGRectMake(266.2, 101, 50, 12);
            ...
            arrowlabel4.text = @"↓";
            arrowlabel4.font = [UIFont boldSystemFontOfSize:15.0f];
