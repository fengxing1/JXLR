...
- (void)initView
{
    ...
    //滚动视图
    _scrollView =[[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, HeightScreen-HeightNavigationAndStateBar)];
    ...
    UILabel  *textlabel1 = [[UILabel alloc] initWithFrame:CGRectMake(10, SpaceMediumSmall, 260,30)];
    ...
    backView1.frame=CGRectMake(0, SpaceSmall/2, self.view.frame.size.width, CGRectGetMaxY(_featuretextView.frame)+SpaceMediumSmall);
    ...
    _crowdtextView = [[UITextView alloc] initWithFrame:CGRectMake(70, 5, 220, 60)];
    ...
    backView2.frame=CGRectMake(0, CGRectGetMaxY(backView1.frame)+SpaceMediumSmall, self.view.frame.size.width, CGRectGetMaxY(_crowdtextView.frame)+SpaceMediumSmall);
    
    
    _backView3 = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(backView2.frame)+SpaceMediumSmall, self.view.frame.size.width, 170)];
    ...
    backView4 = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_backView3.frame)+SpaceMediumSmall, self.view.frame.size.width, 98)];
    ...
    _scrollView.contentSize = CGSizeMake(self.view.frame.size.width, CGRectGetMaxY(backView4.frame)+SpaceBig);
}
...
- (void)initNavigationBar
{
    ...
    // 导航条返回按钮
    BarButtonItem *publishItem=[BarButtonItem barItemRightDefaultWithTitle:@"发布借款" target:self action:@selector(publishClick)];
...
-(void) httpResponseSuccess:(NetWorkClient *)client dataTask:(NSURLSessionDataTask *)task didSuccessWithObject:(id)obj
{
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        _featuretextView.frame = CGRectMake(70, 10, self.view.frame.size.width-80,_label1Sz.height*1.5 + 10);
        
        backView1.frame = CGRectMake(0, SpaceSmall/2, self.view.frame.size.width, CGRectGetMaxY(_featuretextView.frame)+SpaceMediumSmall);
        
        backView2.frame = CGRectMake(0,CGRectGetMaxY(backView1.frame)+SpaceMediumSmall, self.view.frame.size.width, 70);
        _backView3.frame =CGRectMake(0,CGRectGetMaxY(backView2.frame)+SpaceMediumSmall, self.view.frame.size.width, 170);
        backView4.frame= CGRectMake(0,CGRectGetMaxY(_backView3.frame)+SpaceMediumSmall, self.view.frame.size.width, 98);
