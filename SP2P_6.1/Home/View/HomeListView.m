...
- (void)initView
{
    ...
    _scrollView1.contentSize =  CGSizeMake(3*320, 0);
...
-(void)scrollTimer{
    ...
    switch (timeCount) {
        ...
        case 1:
        {
            ...
            [_scrollView setContentOffset:CGPointMake(320.0, 0) animated:YES];
        }
            break;
        ...
        case 2:
        {
            ...
            [_scrollView setContentOffset:CGPointMake(640.0, 0) animated:YES];
        }
            break;
...
-(void)scrollTimer1
{
    ...
    switch (timeCount1) {
        ...
        case 1:
        {
            ...
            [_scrollView1 setContentOffset:CGPointMake(320.0, 0) animated:YES];
        }
            break;
        ...
        case 2:
        {
            ...
            [_scrollView1 setContentOffset:CGPointMake(640.0, 0) animated:YES];
        }
            break;
