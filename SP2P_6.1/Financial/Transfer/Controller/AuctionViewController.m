...
- (void)initView
{
    ...
    UILabel *idtextLabel = [[UILabel alloc] initWithFrame:CGRectMake(WidthScreen-95, 8, 80, 30)];
    idtextLabel.text = @"编号:";
    ...
    _idLabel = [[UILabel alloc] initWithFrame:CGRectMake(WidthScreen-65, 8, 100, 30)];
    ...
    _backView2  = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(backView1.frame)+5, self.view.frame.size.width, self.view.frame.size.height-68)];
  ...
  //  [_backView2 addSubview:passwordLabel];
    ...
    _TendermoneyField = [[UITextField alloc] initWithFrame:CGRectMake(110,145, WidthScreen-195,30)];
    ...
    _passwordField = [[UITextField alloc] initWithFrame:CGRectMake(110, 185, WidthScreen-195,30)];
  ...
  //  [_backView2 addSubview:_passwordField];
    ...
    _auctionBtn.frame = CGRectMake(_backView2.frame.size.width*0.5-50, CGRectGetMaxY(_TendermoneyField.frame)+25,110, 27);
...
- (void)initNavigationBar
{
    ...
    // 导航条分享按钮
    BarButtonItem *ShareItem=[BarButtonItem barItemRightDefaultWithTitle:@"分享" target:self action:@selector(ShareClick)];
...
- (void)RechargeBtnClick
{
    ...
    [self.navigationController presentViewController:RechargeNav animated:YES completion:nil];
}
