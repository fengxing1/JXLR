...
- (void)initView
{
    ...
    UILabel *idtextLabel = [[UILabel alloc] initWithFrame:CGRectMake(240, 10, 80, 25)];
    idtextLabel.text = @"编号: ";
    ...
    _idLabel = [[UILabel alloc] initWithFrame:CGRectMake(270, 10, 80, 25)];
    ...
    _dateLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(96, 38, 110, 20)];
    ...
    bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 44-HeightNavigationAndStateBar, self.view.frame.size.width, 44)];
    bottomView.backgroundColor = [UIColor whiteColor];
    bottomView.hidden = YES;
    [self.view insertSubview:bottomView aboveSubview:_ScrollView];
    
    
    UIButton *auctionBtn =[ToolButton CreateMainButton:CGRectMake(SpaceBig, SpaceSmall, WidthScreen-SpaceBig*2, 44-SpaceSmall*2) withTitle:@"我要竞拍" withTarget:self withAction:@selector(auctionBtnClick)];
...
- (void)ShareClick
{
    if (AppDelegateInstance.userInfo == nil) {
        ...
        //构造分享内容
        id<ISSContent> publishContent = [ShareSDK content:[NSString stringWithFormat:@"来融金服 债权标详情%@",shareUrl]
