...
- (void)initView
{
    ...
    //滚动视图
    _ScrollView =[[MSKeyboardScrollView alloc] initWithFrame:CGRectMake(0, SpaceSmall/2, self.view.frame.size.width, self.view.frame.size.height-64)];
    ...
    //邮箱输入框
    _mailField = [[UITextField alloc] initWithFrame:CGRectMake(CGRectGetMaxX([self.view viewWithTag:(2+100)].frame) + 4, CGRectGetMidY([self.view viewWithTag:(3+10)].frame) - 13, 180, 26)];
    ...
    _verifyBtn1.backgroundColor  = ColorBGGray;
