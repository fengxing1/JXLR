...
- (void)initView
{
    ...
    _userName = [[UILabel alloc] initWithFrame:CGRectMake(10, SpaceMediumSmall, 300, 30)];
    ...
    UILabel *textlabel2 = [[UILabel alloc] initWithFrame:CGRectMake(10, SpaceMediumSmall+30, 300, 30)];
    textlabel2.text = @"您的信用等级为:";
    textlabel2.font = [UIFont boldSystemFontOfSize:16.0f];
    [self.view addSubview:textlabel2];
    
    _creditLevel = [[UIImageView alloc] initWithFrame:CGRectMake(135, SpaceMediumSmall+32, 25, 25)];
   // _creditLevel.contentMode = UIViewContentModeScaleAspectFit;
    [self.view addSubview:_creditLevel];
    
    UILabel *textlabel3 = [[UILabel alloc] initWithFrame:CGRectMake(10, SpaceMediumSmall+60, 300, 30)];
    textlabel3.text = @"信用积分:";
    textlabel3.font = [UIFont boldSystemFontOfSize:16.0f];
    [self.view addSubview:textlabel3];

    _creditIntegrallabel = [[UILabel alloc] initWithFrame:CGRectMake(90, SpaceMediumSmall+60, 150, 30)];
    ...
    UILabel *textlabel4 = [[UILabel alloc] initWithFrame:CGRectMake(10, SpaceMediumSmall+90, 300, 30)];
    textlabel4.text = @"当前信用额度:";
    textlabel4.font = [UIFont boldSystemFontOfSize:16.0f];
    [self.view addSubview:textlabel4];
    
    _creditLimitlabel = [[UILabel alloc] initWithFrame:CGRectMake(120, SpaceMediumSmall+90, 300, 30)];
    ...
    _overCreditLinelabel = [[UILabel alloc] initWithFrame:CGRectMake(10, SpaceMediumSmall+150, 300, 20)];
...
-(void) setView
{
    [_creditLevel sd_setImageWithURL:[NSURL URLWithString:_creditLevelModel.creditRating] placeholderImage:[UIImage imageNamed:@"news_image_default"]];
    ...
    UILabel *textlabel31 = [[UILabel alloc] initWithFrame:CGRectMake(_creditIntegrallabel.frame.origin.x+CreditIntegrallabelSiZe.width+5, 130, SpaceMediumSmall+230, 30)];
    textlabel31.text = @"分";
...
- (void)initNavigationBar
{
    self.title = @"信用等级";
    // 导航条返回按钮
    BarButtonItem *barRightItem=[BarButtonItem barItemRightDefaultWithTitle:@"积分明细" target:self action:@selector(RightItemClick)];
