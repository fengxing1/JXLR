...
- (void)initView
{
    ...
    _listView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height-HeightNavigationAndStateBar) style:UITableViewStyleGrouped];
